 ...
 * @UniqueEntity(fields={"email"}, message="This is already an email with this email")
...
class User implements UserInterface
{
     ...
     *     message="Password has to contain minimum 8 character at least one Uppercase and lowercase one number and special character"
     * )
     */
    private $password;
    ...
    public function __construct()
    {
        ...
        $this->setEmailVector(openssl_random_pseudo_bytes(openssl_cipher_iv_length(self::CIPHER)));
    }
     ...
     * @ORM\PostLoad()
     */
    public function decrypteEmail(){

        $this->setEmail(openssl_decrypt(
            $this->getEmail(),
            self::CIPHER,
            $this->getUsername(),
            0,
